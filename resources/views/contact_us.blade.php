	...
	<div class="page-content bg-white">
					...
					<div class="col-lg-4 col-md-6 m-b20">
						<div class="icon-bx-wraper box-hover style-3">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b5 text-capitalize">Phone</h5>
								<span>+48 577 410 288</span>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 m-b20">
						<div class="icon-bx-wraper box-hover style-3">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b5 text-capitalize">Mail</h5>
								<span>info@tamilsangam.pl</span>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 m-b20">
						<div class="icon-bx-wraper box-hover style-3">
							...
							<div class="icon-content">
								<h5 class="dz-tilte m-b5 text-capitalize">Our Address</h5>
								<span>STOWARZYSZENIE TAMIL SANGAM W POLSCE<br>UL. Sielska 136/1, 05-510 Chylice Polska</span>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="content-inner map-wrapper1">
			<div class="container-fluid">
				...
				<!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2443.827964813987!2d21.068533815938437!3d52.09802967973365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471ec98c8a9d6a1b%3A0x24e9374d5a1a25e8!2sUL.%20Sielska%20136%2F1%2C%2005-510%20Chylice%2C%20Poland!5e0!3m2!1sen!2sus!4v1688466123448!5m2!1sen!2sus" style="border:0;" allowfullscreen="" loading="lazy"></iframe> -->
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d204894.2177615093!2d20.8515801!3d52.2296756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471ecc669c4792a3%3A0x6cfcd50e87f0d547!2sWarsaw%2C%20Poland!5e0!3m2!1sen!2s!4v1688466123448!5m2!1sen!2s" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
				</div>
									...
									<div class="row sp15">
										<div class="col-md-6">
											...
											<div class="input-group">
												<input name="dzFirstName" required type="text" class="form-control" placeholder="John">
											</div>
										</div>
										<div class="col-md-6">
											<label class="form-label">Last Name</label>
											<div class="input-group">
												<input name="dzLastName" required type="text" class="form-control" placeholder="Deo">
											</div>
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-12">
											<button name="submit" type="submit" value="Submit" class="btn btn-secondary">Submit Now</button>
										</div>
									</div>
								</form>
							</div>	
			...
			<svg class="shape-2 move-2" viewBox="0 0 95 95" xmlns="http://www.w3.org/2000/svg" xmlns:v="https://vecta.io/nano" width="95" height="95" fill="none">
				<mask id="A" maskUnits="userSpaceOnUse" x="0" y="0" width="95" height="95" mask-type="alpha">
				  <circle cx="47.5" cy="47.5" r="47" fill="#d9d9d9" stroke="#3b6ff5"></circle>
				</mask>
				<g mask="url(#A)">
			...
			<svg class="shape-3 move-2" xmlns="http://www.w3.org/2000/svg" width="114" height="114" viewBox="0 0 114 114" fill="none">
				<g opacity="0.2">
				  <rect x="63.3936" y="11.6357" width="15.3997" height="89.934" transform="rotate(18.3505 63.3936 11.6357)" fill="var(--primary)"></rect>
				  <rect x="93.6138" y="30.0967" width="15.3997" height="89.934" transform="rotate(63.3505 93.6138 30.0967)" fill="var(--primary)"></rect>
				  <rect width="15.3997" height="89.934" transform="matrix(0.314829 -0.949148 -0.949148 -0.314829 96.9966 78.5947)" fill="var(--primary)"></rect>
