...
@section('content')
	...
	<div class="page-content bg-white">
		...
		<div class="content-inner-2">
			<div class="container">
				<div class="row dz-terms">
					<div class="col-xl-4 col-lg-5 m-b40">
						<aside class="side-bar sticky-top">
							<div class="dz-terms-list">
								<ul class="navbar-nav navbar-scroll">
									<li><a href="#scrollNavSection01" class="nav-link scroll">Terms And CareerExplorer</a></li>
									<li><a href="#scrollNavSection02" class="nav-link scroll">User Account</a></li>
									<li><a href="#scrollNavSection03" class="nav-link scroll">Electronic Communication</a></li>
									<li><a href="#scrollNavSection04" class="nav-link scroll">User Data And Privacy</a></li>
									<li><a href="#scrollNavSection05" class="nav-link scroll">Ownership Of CareerExplorer</a></li>
									<li><a href="#scrollNavSection06" class="nav-link scroll">Additional Terms</a></li>
									<li><a href="#scrollNavSection07" class="nav-link scroll">Your Responsibilities</a></li>
									<li><a href="#scrollNavSection08" class="nav-link scroll">Communications Not Confidential</a></li>
									<li><a href="#scrollNavSection09" class="nav-link scroll">Feedback</a></li>
									<li><a href="#scrollNavSection10" class="nav-link scroll">Contact</a></li>
								</ul>
							</div>
						</aside>
					</div>
					...
					<div class="col-xl-8 col-lg-7">
						...
						<div class="dz-terms-content" id="scrollNavSection01">
							<h4 class="title">Changes To These Member Terms And Career Explorer</h4>
							<ul>
						...
						<div class="dz-terms-content" id="scrollNavSection02">
						...
						<div class="dz-terms-content" id="scrollNavSection03">
							<h4 class="title">Electronic Communication</h4>
							<ul>
						...
						<div class="dz-terms-content" id="scrollNavSection04">
							<h4 class="title">User Data And Privacy</h4>
							<ul>
						...
						<div class="dz-terms-content" id="scrollNavSection05">
							<h4 class="title">Ownership Of CareerExplorer</h4>
							<ul>
						...
						<div class="dz-terms-content" id="scrollNavSection06">
							<h4 class="title">Additional Terms</h4>
						...
						<div class="dz-terms-content" id="scrollNavSection07">
							<h4 class="title">Your Responsibilities</h4>
							<p>You agree to:</p>
							<ul>
						...
						<div class="dz-terms-content" id="scrollNavSection08">
							<h4 class="title">Communications Not Confidential</h4>
						...
						<div class="dz-terms-content" id="scrollNavSection09">
						...
						<div class="dz-terms-content" id="scrollNavSection10">
							<h4 class="title">Contact</h4>
							<p>If you have any questions or comments regarding these Member Terms, please contact us at <strong><a class="text-dark gmail" target="_blank" href="mailto:dexignzones@gmail.com">dexignzones@gmail.com</a></strong></p>
						</div>
