						...
						<div class="banner-inner" style="background-image: url(images/main-slider/slider1/slide_bg1.jpg)">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-lg-6 col-md-12">
										<div class="banner-media row gx-4">
											<div class="col-5">
												<div class="main-img1">
									...
									<div class="col-lg-6 col-md-12">
										<div class="banner-content">
											<div class="top-content">
												...
												<h1 class="title">TAMIL SANGAM ASSOCIATION OF POLAND</h1>
												<p>We are greatly indebted to the pillars of the Tamil Sangam Association of Poland, the executive committee members who give their valuable time and effort voluntarily to accomplish the objectives of this great organisation. I welcome your valuable suggestions to serve the Tamil community in the Poland and elsewhere</p>
												<div class="d-flex align-items-center">
													<a class="btn btn-primary btnhover1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalDonate">
														<span>Donate</span>
														<i class="flaticon-heart text-secondary ms-3"></i>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 wow fadeInUp" data-wow-delay="0.2s">
						<div class="donate-form form-wrapper" style="background-image:url('images/background/bg2.jpg');">
										...
										<div class="col-lg-12">
											<div class="form-group">
												<div class="input-group">
													<input type="text" name="dzOther[Other_Amount]" class="form-control donate-input" value="" required placeholder="Other Amount (USD)">
												</div>
											</div>
										</div>
										<div class="col-lg-12">
						...
						<div class="row justify-content-center">
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="0.2s">
									<div class="icon-bx-sm m-b20">
										...
										<div class="why">
											<!-- inline style used -->
										 <img class="img-1" style="width:100px; height:90px;" src="{{asset('images/1.png')}}" alt="images">
										</div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="0.4s">
									<div class="icon-bx-sm m-b20">
										<a href="{{url('/project_categories')}}" class="icon-cell">
										<img class="img-1"  style="width:100px; height:90px;" viewBox="0 0 60 60" fill="none" src="{{asset('images/2.png')}}" alt="images">
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="0.6s">
									...
									<img class="img-1" style="width:100px; height:90px;" src="{{asset('images/8.png')}}" alt="images">
										<!-- <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="0.8s">
									<div class="icon-bx-sm m-b20"> <a href="{{url('/project_categories')}}" class="icon-cell">
										...
										<img class="img-1" style="width:100px; height:90px;" src="{{asset('images/3.png')}}" alt="images">
									</a> </div>
									<div class="icon-content">
										<div class="separator"></div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="1.0s">
									<div class="icon-bx-sm m-b20"> <a href="{{url('/project_categories')}}" class="icon-cell">
										...
										<img class="img-1" style="width:100px; height:90px;" src="{{asset('images/4.png')}}" alt="images">
									</a>
									</div>
									<div class="icon-content">
										<div class="separator"></div>
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="1.2s">
									<div class="icon-bx-sm m-b20"> <a href="{{url('/project_categories')}}" class="icon-cell">
										...
										<img class="img-1" style="width:100px; height:90px;" src="{{asset('images/5.png')}}" alt="images">
									</a>
									</div>
									<div class="icon-content">
										<div class="separator"></div>
								...
								<div class="icon-bx-wraper text-center style-4 m-b30 wow fadeInUp" data-wow-delay="1.4s">
									<div class="icon-bx-sm m-b20">
										<a href="{{url('/project_categories')}}" class="icon-cell">
											...
											<img class="img-1" style="width:100px; height:90px;" src="{{asset('images/6.png')}}" alt="images">
										</a>
									</div>
									<div class="icon-content">
										<div class="separator"></div>
		...
		<div class="content-inner-3 section-wrapper7">
			<div class="container">
				<div class="map-wrapper">
					<img src="{{asset('images/map.png')}}" class="main-img" alt="">
					<ul>
						<li class="icon-dropdown">
							<div class="right"><p>It is 30% poor in the country</p><a href="javascript:void(0):" class="btn-link" data-bs-toggle="modal" data-bs-target="#modalDonate">Donate Now</a></div>
						</li>
						<li class="icon-dropdown">
							<div class="right"><p>It is 50% poor in the country</p><a href="javascript:void(0):" class="btn-link" data-bs-toggle="modal" data-bs-target="#modalDonate">Donate Now</a></div>
						</li>
						<li class="icon-dropdown">
							<div class="left"><p>It is 25% poor in the country</p><a href="javascript:void(0):" class="btn-link" data-bs-toggle="modal" data-bs-target="#modalDonate">Donate Now</a></div>
						</li>
					</ul>
				</div>
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-4 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.4s">
						<div class="content-bx style-1 bg-secondary text-center">
							<div class="inner-content">
								...
								<a class="btn btn-primary" href="{{url('browse_fundraiser')}}">Online Fundraiser</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.6s">
						<div class="content-bx style-1 bg-dark text-center">
							<div class="inner-content">
								<h2 class="title text-white m-b15 display-4 font-weight-700"><span class="counter">33,986</span><span>+</span></h2>
