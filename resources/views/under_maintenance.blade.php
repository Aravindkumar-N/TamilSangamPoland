...
<div class="page-wraper">
	...
	<!-- Construction -->
	<div class="under-construction overlay-white-dark background-luminosity" style="background-image:url('images/background/bg5.jpg'); background-position: center;">
		...
		<div class="inner-construction">
			...
			<h1 class="dz-head">Site Is Down<br>For Maintenance</h1>
